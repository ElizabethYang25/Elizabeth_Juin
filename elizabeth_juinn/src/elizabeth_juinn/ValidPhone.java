...
public class ValidPhone {
	...
	public static void main(String[] args)
	{
		...
		//System.out.println("Inscrire le numéro de télephone au format (123)-456-7890");// ou points ou espaces
		System.out.println("Inscrire le numéro de télephone au formate (123)-456-7890 Ext 234");
	...
	private static void verifPhone(String tel)
	{
		...
		//Pattern pattern=Pattern.compile("\\(\\d{3}\\)[-\\.\\s]\\d{3}[-\\.\\s]\\d{4}"_;
